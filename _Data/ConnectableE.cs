...
namespace Experimential_Software
{
    ...
    public partial class ConnectableE : Button, IMouseOnEndsControl
    {
        ...
        protected virtual void DrawCubePinkMouseNearEnds(PaintEventArgs e, Point pEnds)
        {
            ...
            {
                int PointDrawm = this.nearPhead ? pEnds.X : pEnds.X - this._radiusPoint;
                var rectEnds = new Rectangle(PointDrawm, (Height - this._radiusPoint) / 2, this._radiusPoint, this._radiusPoint);
